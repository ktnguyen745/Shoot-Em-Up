...
public class SoundManager {
    ...
    public Sound enemy_collision = Gdx.audio.newSound(Gdx.files.internal("sound/Click_04.ogg"));
    public Sound enemy_shoot = Gdx.audio.newSound(Gdx.files.internal("sound/Sequence_01.ogg"));
    public Sound enemy_shoot2 = Gdx.audio.newSound(Gdx.files.internal("sound/Sequence_07.ogg"));
    public Sound player_shoot = Gdx.audio.newSound(Gdx.files.internal("sound/Execute_01.ogg"));
